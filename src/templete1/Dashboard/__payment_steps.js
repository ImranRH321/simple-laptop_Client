 ...
 * 7.error ta useState diye  + display card ar error dekate hobe |
 * ----------------
 * 8.react stipe docs jete hobe tarpor--> sample integration. click kore jeye tapor --> server install korbe -->
 * npm install --save stripe  = korbe
 * 9. get client secret from backend via payment intent post api
 * 10. store client secret on the client side api call
 * 11. Create card payment confirmation --> payment card diya search korle pabo
